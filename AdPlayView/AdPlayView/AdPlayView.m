...
-(void)setImgsArray:(NSArray *)imgsArray
{
    ...
    for (NSInteger i = 0; i < imgsArray.count; i++) {
        AdPlayModel *model = [AdPlayModel new];
...
- (void)initialization
{
    ...
    _adCollectionView.backgroundColor = [UIColor blackColor];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.adPlayModel = self.dataArray[indexPath.item];
    return cell;
}
